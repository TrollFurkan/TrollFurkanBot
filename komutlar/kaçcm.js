...
var uzunluk = ["1", "18", "0", "98", "124", "872", "3", "7", "13"];
    ...
    .setDescription(`**${message.author.tag}** \n\nSenin muzun tam olarak **${sonuc}** uzunluğunda naptın amk sen...`)
    .setFooter('TrollFurkan | 2018', 'https://cdn.discordapp.com/avatars/429500693741568020/d958413ea89bad79fe7c98e97db1c075.png?size=2048')
